...
function updateTheme(theme) {
    ...
    let sidebarGrad1 = theme == 'light' ? "255, 255, 255" : "35, 35, 35";
    let sidebarGrad2 = theme == 'light' ? "251, 247, 255" : "46, 46, 46";
    ...
    root.style.setProperty("--sidebar-gradient-1", sidebarGrad1);
    root.style.setProperty("--sidebar-gradient-2", sidebarGrad2);
